...
public class HealthDetention extends StraySalary {

    private final static Double plafond = Double.valueOf(20000);

    public HealthDetention (PersonnelService personnelService, Long IdPersonnel){
        super.setIdPersonnel(IdPersonnel);
        super.setDesignation("Retenue sanitaire");
